package com.bycoders.infrastructure.converter;
...
import com.bycoders.domain.entities.implementations.CommonStore;
import com.bycoders.domain.entities.implementations.CommonUser;
...
import com.bycoders.infrastructure.database.mappers.StoreMapper;
import com.bycoders.infrastructure.database.mappers.TransactionMapper;
import com.bycoders.infrastructure.database.mappers.UserMapper;
import lombok.*;
...
public class TransactionConverter {
    ...
    public void verifyLineInvalid(String line) throws Exception {
        if (line == null || line.isEmpty() || line.length() != 80) {
            throw new ByCodersAppException("Line is invalid, please verify!");
        }
    }
